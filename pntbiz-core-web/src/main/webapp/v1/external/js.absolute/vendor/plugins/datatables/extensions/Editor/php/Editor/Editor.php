...
class Editor extends Ext {
	 ...
	 * 
	 *    <code>
	 *      SELECT users.first_name, users.last_name, admin.user.dept_id, dept.name
	 *      FROM users
	 ...
	 *
	 * Please be very careful when using this method! If an edit made by a admin.user using
