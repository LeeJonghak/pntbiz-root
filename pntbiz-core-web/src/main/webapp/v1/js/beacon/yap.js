    ...
    elementHandler.bind({
        ...
        formBtn: 'beacon/yap/geofencing/form.do',
        $mformBtn:'beacon/yap/geofencing/mform.do?fcNum=${fcNum}&page=#{page}&opt=#{opt}&keyword=#{keyword}',
        listBtn: 'beacon/yap/geofencing/list.do?page=#{page}&opt=#{opt}&keyword=#{keyword}',
        regBtn: {
            action: 'submit',
            form: 'form1',
            url: 'beacon/yap/geofencing/reg.do',
            preHandler: elementHandler.formPreHandler,
            result: {
                1: {message:vm.regSuccess,
                    redirect:'beacon/yap/geofencing/mform.do?fcNum='},
                2: vm.regError
            }
        },
        modBtn: {
            action: 'submit',
            form: 'form1',
            url: 'beacon/yap/geofencing/mod.do',
            preHandler: elementHandler.formPreHandler,
            result: {
                1: {message:vm.modSuccess,
                    redirect:'beacon/yap/geofencing/mform.do?fcNum=#{fcNum}'},
                2: vm.modError
            }
        },
        delBtn: {
            action: 'submit',
            form: 'form1',
            url: 'beacon/yap/geofencing/del.do',
            preHandler:function() {
                return window.confirm(vm.delConfirm);
            },
            result: {
                1: {message:vm.delSuccess,
                    redirect:'beacon/yap/geofencing/form.do'},
                2: vm.delError
            }
        }
    });
