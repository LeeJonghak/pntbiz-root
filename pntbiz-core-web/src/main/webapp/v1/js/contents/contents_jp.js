...
var contents = {
	...
	_conField: {
		// URI형
		"URI" : [{"id" : "url1", "label" : "URL"}, {"id" : "sound1", "label" : "Sound"}],
		// 텍스트형
		"TXT" : [{"id" : "text1", "label" : "Message"}, {"id" : "sound1", "label" : "Sound"}],		
		// 이미지형
		"IMG" : [{"id" : "text1", "label" : "Text1"}, {"id" : "img1", "label" : "Image"}, {"id" : "sound1", "label" : "Sound"}],	
		// 사운드형	
		"SND" : [{"id" : "sound1", "label" : "Sound"}],	
		// 웰컴
		"WEL" : [{"id" : "text1", "label" : "Welcome Message"}, {"id" : "sound1", "label" : "Sound"}],		
		// 굿바이
		"BYE" : [{"id" : "text1", "label" : "Goodbye Message"}, {"id" : "sound1", "label" : "Sound"}],
		// 쿠폰 
		"CPN" : [{"id" : "img1", "label" : "BG-Image"}, {"id" : "text1", "label" : "Text"}, {"id" : "sound1", "label" : "Sound"}],			
		// 동영상
		"VDO" : [{"id" : "text1", "label" : "Text"}, {"id" : "sound1", "label" : "Sound"}, {"id" : "url1", "label" : "Video URL"}],
		// 어린이
		"CHD" : [{"id" : "text1", "label" : "Name"}, {"id" : "img1", "label" : "Picture"} ],
		// 노티
		"NTF" : [{"id" : "text1", "label" : "Sender Email"}, {"id" : "text2", "label" : "Receiver Email"}, {"id" : "text3", "label" : "Subject"}, {"id" : "text4", "label" : "Content"}],
		// 자재
		"MAT" : [{"id" : "img1", "label" : "Icon"}],
		// 복합
		"CPX" : [{"id" : "text1", "label" : "Text1"}, {"id" : "text2", "label" : "Text2"}, {"id" : "text3", "label" : "Text3"}, 
		         {"id" : "text4", "label" : "Text4"}, {"id" : "text5", "label" : "Text5"},
		         {"id" : "img1", "label" : "Image1"}, {"id" : "img2", "label" : "Image2"}, {"id" : "img3", "label" : "Image3"}, 
		         {"id" : "img4", "label" : "Image4"}, {"id" : "img5", "label" : "Image5"},
		         {"id" : "sound1", "label" : "Sound1"}, {"id" : "sound2", "label" : "Sound2"}, {"id" : "sound3", "label" : "Sound3"}, 
		         {"id" : "url1", "label" : "URL1"}, {"id" : "url2", "label" : "URL2"}, {"id" : "url3", "label" : "URL3"}
		],
		// 회원
		"MEM" : [{"id" : "img1", "label" : "Picture"}, {"id" : "text1", "label" : "Name"}, {"id" : "text2", "label" : "PhoneNumber"}]
	},
