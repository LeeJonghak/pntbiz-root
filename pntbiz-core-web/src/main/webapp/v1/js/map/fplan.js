$(document).ready( function() {
	...
	$("#floorModBtn").hide();
	$("#floorDelBtn").hide();
	$("#swLat").bind("change", function() { fplan.setRectangle(); fplan.updateBounds(); });
	$("#swLng").bind("change", function() { fplan.setRectangle(); fplan.updateBounds(); });
	$("#neLat").bind("change", function() { fplan.setRectangle(); fplan.updateBounds(); });
	$("#neLng").bind("change", function() { fplan.setRectangle(); fplan.updateBounds(); });
