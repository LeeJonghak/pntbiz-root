...
FencingMap.prototype.load = function(floor) {
	console.log("floor : " + floor + " / this.floor : " + this.floor);
...
FencingMap.prototype.onFencingClickEvent = function(event, geofencing, poly) {
    ...
    elementHandler.mapPopup.remote('map/yap/geofencingInfo.ajax.do',{fcNum:geofencing.fcNum}, function($element) {
        $element.find('#modBtn').click(function() {
            elementHandler.mapPopup.submit('beacon/yap/geofencing/mod.do', function(data) {
				var result = {};
...
elementHandler.ready(function() {
    ...
    elementHandler.googleMap = new GoogleMap('map-canvas', function() {
        ...
        this.floorMap = new FloorMap(this, this.bssServiceRequest, $("#initFloor").val());
