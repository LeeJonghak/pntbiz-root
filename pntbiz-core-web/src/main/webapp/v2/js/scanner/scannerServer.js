$(document).ready( function() {	
	...
	$('#scannerServerRegBtn2').bind('click', function() { scannerServer.reg(); });
	$('#scannerServerModBtn').bind('click', function() { scannerServer.mod(); });
	$('#scannerServerModBtn2').bind('click', function() { scannerServer.mod(); });
	$('#scannerServerDelBtn').bind('click', function() { scannerServer.del(); });
	$('#scannerServerDelBtn2').bind('click', function() { scannerServer.del(); });
});
