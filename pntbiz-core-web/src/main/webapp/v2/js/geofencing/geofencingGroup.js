$(document).ready( function() {
	...
	$('#geofencingGroupListBtn2').bind('click', function() { geofencingGroup.list(); });
	$('#geofencingGroupRegBtn').bind('click', function() { geofencingGroup.reg(); });
	$('#geofencingGroupRegBtn2').bind('click', function() { geofencingGroup.reg(); });
	$('#geofencingGroupModBtn').bind('click', function() { geofencingGroup.mod(); });
	$('#geofencingGroupModBtn2').bind('click', function() { geofencingGroup.mod(); });
	$('#geofencingGroupDelBtn').bind('click', function() { geofencingGroup.del(); });
	$('#geofencingGroupDelBtn2').bind('click', function() { geofencingGroup.del(); });
});
