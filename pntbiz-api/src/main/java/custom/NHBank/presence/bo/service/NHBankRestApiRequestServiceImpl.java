...
/**
 * 농협 비인가 지역 알림 연동을 위한 커스터 마이징
 *
 * * 비인가 지역 전문 구성을 농협 TTS 연동을 위한 규격으로 변경
 * Created by ucjung on 2017-09-14.
 */

@Service
public class NHBankRestApiRequestServiceImpl implements RestApiRequestService {
    ...
    private Map<String, Object> makeRestrictionInBody(PresenceDataPackage presenceVo, ZoneInOutState zoneInOutState) {
        ...
        bodyParams.put("tts_text", "비인가 지역 출입이 감지되었습니다.");
        return bodyParams;
    }
