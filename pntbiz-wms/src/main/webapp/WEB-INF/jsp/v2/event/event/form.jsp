...
<div class="contentBox">
    <div class="title">
        <b><spring:message code="menu.140102" /></b>
        ...
        <div class="view">
            <table>
                ...
                <tr>
                    ...
                    <td>
                        <input type="text" id="evtName" name="evtName" class="w100p" value="" required="required" maxlength="50" placeholder="<spring:message code="word.event.name" />"  />
                    </td>
                </tr>
                <tr>
                    <th scope="row"><spring:message code="word.event.description" /></th>
                    <td>
                        <input type="text" id="evtDesc" name="evtDesc" class="w100p" value="" maxlength="200" placeholder="<spring:message code="word.event.description" />"  />
                    </td>
                </tr>
                <tr>
