...
<form name="form1" id="form1" class="form-horizontal" role="form">
	<div class="contentBox">
		<div class="title">
			<b><spring:message code="menu.160202"/></b>
		</div>
		<div class="boxCon">
			<div class="btnArea">
				<div class="fl-l">
				...
				<div class="fl-r">
					<input type="submit" id="geofencingGroupRegBtn" value="<spring:message code="btn.register"/>" class="btn-inline btn-regist">
				</div>
			</div>
			<div class="view">
				<table>
					...
					<tr>
						...
						<td><input type="text" id="fcGroupName" name="fcGroupName" class="w100p" value="" required="required" size="30" maxlength="25" placeholder="<spring:message code="word.geofencing.group.name"/>"/></td>
					</tr>
					</tbody>
				</table>
			</div>
			<div class="btnArea">
				...
				<div class="fl-r">
					<input type="submit" id="geofencingGroupRegBtn2" value="<spring:message code="btn.register"/>" class="btn-inline btn-regist">
				</div>
			</div>
		</div>
	</div>
