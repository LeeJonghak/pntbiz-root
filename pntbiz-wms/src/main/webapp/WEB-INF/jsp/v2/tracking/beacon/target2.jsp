...
<head>
	...
	<script type="text/javascript">
		window.layoutGnb = { mainmenu: '08', submenu: '03',
			location: ['<spring:message code="menu.170000" />', '<spring:message code="menu.170211" />']
		};
		...
		prop.put('url.tracking.log', '<c:url value="/maptool/data/presenceBeaconLog.do"/>');
		...
		prop.put('export.data.column',['logNum', 'phoneNumber', 'deviceInfo', 'lat', 'lng', 'regDate']);
		...
		pnt.util.onReady(function() {
			...
			$('#presenceTargetRunBtn').on('click', function(evt) {
				...
				trackingMap.playTrackingTimestamp(null, phoneNumber, sTimestamp, eTimestamp);
...
<div class="contentBox">
	<div class="title">
		<b><spring:message code="menu.170211" /></b>
	</div>
	<div class="boxCon">
		<div class="listResearch">
			<form name="form1" id="form1" class="form-inline" role="form">
				...
				<%--<input type="text" placeholder="검색어를 입력하세요" id="phoneNumber" name="phoneNumber" class="w300">--%>
				...
				<div class="list" id="presenceLog" style="margin:0px;">
					<table id="presenceLogTable">
						...
						<tr>
							...
							<th scope="col" data-field="phoneNumber">phoneNumber</th>
							<th scope="col" data-field="deviceInfo">deviceInfo</th>
