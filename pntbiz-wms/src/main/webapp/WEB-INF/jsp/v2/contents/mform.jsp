...
<div class="contentBox">
    <div class="title">
        <b><spring:message code="menu.130103" /></b>
    ...
    <div class="boxCon">
        <div class="btnArea">
            ...
            <div class="fl-r">
                <input type="submit" value="<spring:message code="btn.modify"/>" class="btn-inline btn-modify contentsModBtn">
                <a href="#" class="btn-inline btn-delete contentsDelBtn"><spring:message code="btn.delete"/></a>
            </div>
        </div>
            ...
            <div class="view">
                ...
                <table>
                    ...
                    <tr>
                        ...
                        <td>
                            <select name="conType" id="conType" class="w100p" disabled>
                    ...
                    <tr>
                        ...
                        <td><input type="text" id="conName" name="conName" value="${contentsInfo.conName}" maxlength="25" class="w100p" placeholder="<spring:message code="word.contents.name" />"  /></td>
                    </tr>
                    <%-- 광고제공자
                    <tr>
                        ...
                        <td>
                            ...
                            <input type="text" id="acName" name="acName" value="${contentsInfo.acName}" maxlength="25" class="w100p" placeholder="<spring:message code="word.advertising.provider" />" data-provide="typeahead" data-items="4" />
                        </td>
                    </tr>--%>
                    <tr>
                        <th scope="row"><spring:message code="word.validity.date" /></th>
                        <td>
                            <%--<input type="text" name="sDate" id="sDate" class="useDatepicker" value="${contentsInfo.sDateText}" placeholder="<spring:message code="word.start.date" />">--%>

							<input type="hidden" id="sDate" name="sDate" data-target-prefix="start" data-format="YYYY-MM-DD HH:mm:ss" class="pnt-datetime-format" value="${contentsInfo.sDateText}" />
							...
							<input type="hidden" id="eDate" name="eDate" data-target-prefix="end" data-format="YYYY-MM-DD HH:mm:ss" class="pnt-datetime-format" value="${contentsInfo.eDateText}" />
                    ...
                    <tr>
                        ...
                        <td><input type="text" id="rssi" name="rssi" value="${contentsInfo.rssi}" maxlength="5" class="w100p"  /></td>
                    </tr>
                    <tr id="form-img1">
                    ...
                    <tr id="form-text1">
                        ...
                        <td>
                            <input type="text" id="text1" name="text1" class="w100p" placeholder="text1" value="${contentsInfo.text1}"/>
                        </td>
                    </tr>
                    <tr id="form-text2">
                        <th scope="row" id="label-text2">text2</th>
                        <td>
                            <input type="text" id="text2" name="text2" class="w100p" placeholder="text2" value="${contentsInfo.text2}"/>
                        </td>
                    </tr>
                    <tr id="form-text3">
                        <th scope="row" id="label-text3">text3</th>
                        <td>
                            <input type="text" id="text3" name="text3" class="w100p" placeholder="text3" value="${contentsInfo.text3}"/>
                        </td>
                    </tr>
                    <tr id="form-text4">
                        <th scope="row" id="label-text4">text4</th>
                        <td>
                            <input type="text" id="text4" name="text4" class="w100p" placeholder="text4" value="${contentsInfo.text4}"/>
                        </td>
                    </tr>
                    <tr id="form-text5">
                        <th scope="row" id="label-text5">text5</th>
                        <td>
                            <input type="text" id="text5" name="text5" class="w100p" placeholder="text5" value="${contentsInfo.text5}"/>
                        </td>
                    </tr>
                    <tr id="form-sound1">
                    ...
                    <tr>
                        ...
                        <td><textarea <%--name="wordlength"--%> id="conDesc" name="conDesc"  rows="10" class="w100p" data-limitByte="200" placeholder="<spring:message code="word.description" />" >${contentsInfo.conDesc}</textarea></td>
                    </tr>
                    </tbody>
                </table>
            </div>
        ...
        <div class="btnArea">
            ...
            <div class="fl-r">
                <input type="button" class="btn-inline btn-modify contentsModBtn" value="<spring:message code="btn.modify" />">
                 <input type="button" class="btn-inline btn-delete contentsDelBtn" value="<spring:message code="btn.delete" />">
            </div>
        </div>
    </div>
</div>
