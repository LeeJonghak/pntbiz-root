...
<div class="topbar-left">
    <ol class="breadcrumb">
        <li class="crumb-active"><a href="###"><spring:message code="menu.180200" /></a></li>
        <li class="crumb-icon"><a href="/dashboard/main.do"><span class="glyphicon glyphicon-home"></span></a></li>
        <li class="crumb-trail"><spring:message code="menu.180000" /></li>
        <li class="crumb-trail"><spring:message code="menu.180200" /></li>
    </ol>
</div>
    ...
    <div class="panel">
        ...
        <div class="panel-body pn">
            <table class="table table-striped table-hover" onclick="sortColumn(event)">
                ...
                <tr class="trLoop" id="${list.id}">
                    <td><c:out value="${list.name}"/>
                        <br/><c:out value="${list.macAddr}"/>
