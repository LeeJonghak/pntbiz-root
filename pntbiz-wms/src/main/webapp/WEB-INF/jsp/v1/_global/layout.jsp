...
<c:choose>
    ...
    <c:when test="${pageContext.request.serverName eq 'onticplace.cwit.co.kr'}">
    	<link rel="shortcut icon" href="<spring:eval expression='@config[staticURL]'/>/images/_global/favicon_cwit.ico" type="image/x-icon"/>
        <link rel="icon" href="<spring:eval expression='@config[staticURL]'/>/images/_global/favicon_cwit.ico" type="image/x-icon"/>
    </c:when>
    <c:otherwise>
...
<div id="main">
	<div class="modal fade modal-wide" id="modal" tabindex="-1" role="dialog" aria-labelledby="1" aria-hidden="true">
	...
	<page:applyDecorator page="${viewProperty.viewPathPrefix}/_global/top.jsp" name="top"/>
...
<script type="text/javascript" src="${viewProperty.staticUrl}/external/js.absolute/vendor/plugins/circles/circles.js?v=<spring:eval expression='@config[buildVersion]'/>"></script>

<!-- flotchart Plugin -->
<script type="text/javascript" src="${viewProperty.staticUrl}/external/js.absolute/vendor/plugins/flot/jquery.flot.js?v=<spring:eval expression='@config[buildVersion]'/>"></script>
<script type="text/javascript" src="${viewProperty.staticUrl}/external/js.absolute/vendor/plugins/flot/jquery.flot.resize.min.js?v=<spring:eval expression='@config[buildVersion]'/>"></script>
...
<!--  -->
<script type="text/javascript" src="${viewProperty.staticUrl}/external/js.absolute/vendor/plugins/waypoints/jquery.waypoints.min.js?v=<spring:eval expression='@config[buildVersion]'/>"></script>
<!-- Theme Javascript -->
...
<!-- FileUpload JS -->
<script type="text/javascript" src="${viewProperty.staticUrl}/external/js.absolute/vendor/plugins/fileupload/fileupload.js?v=<spring:eval expression='@config[buildVersion]'/>"></script>
<script type="text/javascript" src="${viewProperty.staticUrl}/external/js.absolute/vendor/plugins/holder/holder.min.js?v=<spring:eval expression='@config[buildVersion]'/>"></script>
<!-- Select2 Plugin Plugin -->
<script type="text/javascript" src="${viewProperty.staticUrl}/external/js.absolute/vendor/plugins/select2/select2.min.js"></script>
<script type="text/javascript" src="${viewProperty.staticUrl}/external/js.absolute/vendor/plugins/nestable/jquery.nestable.js?v=<spring:eval expression='@config[buildVersion]'/>"></script>
<!-- main.jsp(대시보드 차트) JS -->
<script src="${viewProperty.staticUrl}/js/dashboard/highcharts.js"></script>
<script src="${viewProperty.staticUrl}/external/js.absolute/vendor/plugins/summernote/summernote.min.js"></script>
