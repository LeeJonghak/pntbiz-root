...
<div class="topbar-left">
	<ol class="breadcrumb">
		<li class="crumb-active"><a href="###"><spring:message code="menu.100103" /></a></li>
	...
	<div class="panel">
		...
		<div class="panel-body">
			<div class="form-group">
			    ...
			    <div class="col-sm-10">
			        <!-- <input type="text" id="UUID" name="UUID" value="${beacon.UUID}" size="50" required="required" maxlength="36" uuid="uuid"  class="form-control" placeholder="UUID"  /> -->
			        <input type="text" id="UUID" name="UUID" value="${beacon.UUID}" size="50" required="required" maxlength="36" class="form-control" placeholder="<spring:message code="word.uuid" />"  />
			    </div>
			</div>
			<div class="form-group">
			    <label class="col-sm-2 control-label"><spring:message code="word.major.version" /></label>
			    <div class="col-sm-10">
			        <input type="number" id="majorVer" name="majorVer" value="${beacon.majorVer}" required="required" size="30" min="0" max="65535" maxlength="25" class="form-control" placeholder="<spring:message code="word.major.version" />"  />
			    </div>
			</div>
			<div class="form-group">
			    <label class="col-sm-2 control-label"><spring:message code="word.minor.version" /></label>
			    <div class="col-sm-10">
			        <input type="text" id="minorVer" name="minorVer" value="${beacon.minorVer}" required="required" size="30" maxlength="25" class="form-control" placeholder="<spring:message code="word.minor.version" />"  />
			    </div>
			</div>
			<div class="form-group">
			...
			<div class="form-group">
			    ...
			    <div class="col-sm-10">
			        <input type="text" id="beaconName" name="beaconName" value="${beacon.beaconName}" required="required" size="30" maxlength="25" class="form-control" placeholder="<spring:message code="word.beacon.name" />"  />
			    </div>
			</div>
			<div class="form-group">
			...
			<div class="form-group">
			    ...
			    <div class="col-sm-10">
			        <input type="number" id="txPower" name="txPower" value="${beacon.txPower}" required="required" size="15" maxlength="12"  class="form-control" placeholder="<spring:message code="word.txpower" />" />
			    </div>
			</div>
			<div class="form-group">
			    ...
			    <div class="col-sm-10">
			        <div class="col-sm-3 form-group">
			            <input type="number" id="lat" name="lat" value="${beacon.lat}" size="15" required min="-90" max="90" maxlength="20"  class="form-control" placeholder="<spring:message code="word.lat" />" />
			        </div>
			        <div class="col-sm-3 form-group">
			            <input type="number" id="lng" name="lng" value="${beacon.lng}" size="15" required min="-180" max="180" maxlength="20"  class="form-control" placeholder="<spring:message code="word.lng" />" />
			        </div>
			    ...
			    <div class="col-sm-10">
			        <select class="form-control" name="floor" id="floor-selector">
			            <c:forEach items="${floorList}" var="floor">
			                <option value="${floor.floor}" <c:if test="${floor.floor eq beacon.floor}">selected</c:if>><c:out value="${floor.floorName}"/></option>
			            </c:forEach>
			        </select>
			    </div>
			</div>
			<div class="form-group form-inline">
				...
				<div class="col-sm-10">
					<input type="text" id="field1" name="field1"  value="${beacon.field1}" size="15" minlength="1" maxlength="50" class="form-control" placeholder="<spring:message code="word.beacon.field" /> 1" />
					<input type="text" id="field2" name="field2"  value="${beacon.field2}" size="15" minlength="1" maxlength="50" class="form-control" placeholder="<spring:message code="word.beacon.field" /> 2" />
					<input type="text" id="field3" name="field3"  value="${beacon.field3}" size="15" minlength="1" maxlength="50" class="form-control" placeholder="<spring:message code="word.beacon.field" /> 3" />
					<input type="text" id="field4" name="field4"  value="${beacon.field4}" size="15" minlength="1" maxlength="50" class="form-control" placeholder="<spring:message code="word.beacon.field" /> 4" />
					<input type="text" id="field5" name="field5"  value="${beacon.field5}" size="15" minlength="1" maxlength="50" class="form-control" placeholder="<spring:message code="word.beacon.field" /> 5" />
				</div>
			</div>
			<div class="form-group">
			    <label class="col-sm-2 control-label"><spring:message code="word.description" /></label>
			    <div class="col-sm-10">
			        <textarea id="beaconDesc" name="beaconDesc" class="form-control" placeholder="<spring:message code="word.description" />" cols="6" rows="5" maxlength="200">${beacon.beaconDesc}</textarea>
			...
			<div class="form-group">
				...
				<div class="col-sm-10">
					<input type="text" id="externalId" name="externalId" value="${beacon.externalId}" size="30" maxlength="25" class="form-control" placeholder="<spring:message code="word.external.id" />"  />
				</div>
			</div>
			<div class="form-group">
				<label class="col-sm-2 control-label"><spring:message code="word.barcode" /></label>
				<div class="col-sm-10">
					<input type="text" id="barcode" name="barcode" value="${beacon.barcode}" size="30" maxlength="25" class="form-control" placeholder="<spring:message code="word.barcode" />"  />
				</div>
			</div>
			<div class="form-group">
				<label class="col-sm-2 control-label" id="externalAttribute"><spring:message code="word.external.attribute" /></label>
				<div class="col-sm-10">
					<input type="hidden" name="jsonData" id="jsonData" value='${beacon.externalAttributeRaw}'><%--${beacon.externalAttributeRaw}--%>
			...
			<div class="form-group">
			    <label class="col-sm-2 control-label"><spring:message code="word.last.date" /></label>
			    <div class="col-sm-10">
			    	<input type="text" class="form-control pnt-timestamp" data-timestamp="${beacon.lastDate}" data-format="YYYY-MM-DD HH:mm:ss" readonly />

			    </div>
			</div>
			<sec:authorize access="principal.companyNumber eq 100000">
			<div class="form-group">
			    <label class="col-sm-2 control-label"><spring:message code="word.install.image" /></label>
			    <div class="col-sm-10">
			        <img src="http://54.65.251.37/beacon/${beacon.minorVer}.jpg" width="360" onerror="$('#beacon-install-img-not-found').show();$(this).hide();"/>
			        <div id="beacon-install-img-not-found" style="display:none;padding-top:10px;"><span class="label label-primary"><spring:message code="word.none" /></span></div>
			    </div>
			</div>
			</sec:authorize>
		</div>
