...
<div class="topbar-left">
	<ol class="breadcrumb">
		<li class="crumb-active"><a href="###"><spring:message code="menu.140202" /></a></li>
	...
	<div class="panel"> 
		...
		<div class="panel-body">
			...
			<div class="form-group">
				...
				<div class="col-sm-10">
					<input type="text" id="evtTypeCode" name="evtTypeCode" value="" size="10" required="required" maxlength="10" class="form-control" placeholder="<spring:message code="word.event.type.code" />"  />
				</div>
			</div>
			<div class="form-group">
				<label class="col-sm-2 control-label"><spring:message code="word.event.type" /></label>
				<div class="col-sm-10">
					<input type="text" id="evtTypeName" name="evtTypeName" value="" size="50" required="required" maxlength="50" class="form-control" placeholder="<spring:message code="word.event.type" />"  />
				</div>
			</div>
				...
				<div class="col-sm-10">
					<div id="dynamic-column">
						<div class="form-group">
							...
							<div class="col-sm-3">
								<input type="text" name="evtColID" maxlength="20" placeholder="<spring:message code="word.column.id" />" class="txt-col-id form-control"/>
							</div>
							<div class="col-sm-3">
								<input type="text" name="evtColName" maxlength="50" placeholder="<spring:message code="word.column.name" />" class="txt-col-name form-control"/>
							</div>
							<div class="col-sm-2">
