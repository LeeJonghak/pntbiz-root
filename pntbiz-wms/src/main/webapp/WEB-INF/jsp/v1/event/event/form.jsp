...
<div class="topbar-left">
	<ol class="breadcrumb">
		<li class="crumb-active"><a href="###"><spring:message code="menu.140102" /></a></li>
	...
	<div class="panel"> 
		...
		<div class="panel-body">
			<div class="form-group">
				...
				<div class="col-sm-10">
					<input type="text" id="evtName" name="evtName" value="" size="50" required="required" maxlength="50" class="form-control" placeholder="<spring:message code="word.event.name" />"  />
				</div>
			</div>
			<div class="form-group">
				<label class="col-sm-2 control-label"><spring:message code="word.event.description" /></label>
				<div class="col-sm-10">
					<input type="text" id="evtDesc" name="evtDesc" value="" size="200" maxlength="200" class="form-control" placeholder="<spring:message code="word.event.description" />"  />
				</div>
			</div>
			<div class="form-group">
				...
				<div class="col-sm-10">
					<select id="evtTypeCode" name="evtTypeCode" required="required" class="form-control">
						<option><spring:message code="word.event.type.name" /></option>
						<c:forEach items="${eventTypeList}" var="eventType">
							<option value="${eventType.evtTypeCode}">${eventType.evtTypeName}</option>
						</c:forEach>
					</select>
				</div>
			</div>
