...
<input type="hidden" id="acNum" name="acNum" value="${advertCompanyInfo.acNum}" />

<header id="topbar" class="alt">
<div class="topbar-left">
	<ol class="breadcrumb">
		<li class="crumb-active"><a href="###"><spring:message code="menu.990303" /></a></li>
	...
	<div class="panel"> 
		...
		<div class="panel-body">
			<div class="form-group">
				...
				<div class="col-sm-10">
					<input type="text" id="acName" name="acName" value="${advertCompanyInfo.acName}" maxlength="25" class="form-control" placeholder="<spring:message code="word.company.name"/>"  />
				</div>
			</div>
		</div>
		...
		<div class="panel-footer clearfix">
			<div class="pull-right">
				<button id="advertCompanyModBtn" type="button" class="btn btn-primary btn-sm"><spring:message code="btn.modify"/></button>
				<button id="advertCompanyDelBtn" type="button" class="btn btn-danger btn-sm"><spring:message code="btn.delete"/></button>
