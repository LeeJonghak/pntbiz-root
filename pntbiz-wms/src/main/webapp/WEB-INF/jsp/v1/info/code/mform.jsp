...
<input type="hidden" id="codeNum" name="codeNum" value="${codeActionInfo.codeNum}" />

<header id="topbar" class="alt">
<div class="topbar-left">
	<ol class="breadcrumb">
		<li class="crumb-active"><a href="###"><spring:message code="menu.990203" /></a></li>
	...
	<div class="panel"> 
		...
		<div class="panel-body">
			...
			<div class="form-group">
				...
				<div class="col-sm-10">
					<input type="text" id="code" name="code" value="${codeActionInfo.code}" maxlength="30" class="form-control" placeholder="<spring:message code="word.code"/>"  />
				</div>
			</div>
			<div class="form-group">
				<label class="col-sm-2 control-label"><spring:message code="word.code.name"/></label>
				<div class="col-sm-10">
					<input type="text" id="codeName" name="codeName" value="${codeActionInfo.codeName}" maxlength="25" class="form-control" placeholder="<spring:message code="word.code.name"/>"  />
				</div>
			</div>
		</div>
		...
		<div class="panel-footer clearfix">
			<div class="pull-right">
				<button id="codeActionModBtn" type="button" class="btn btn-primary btn-sm"><spring:message code="btn.modify"/></button>
				<button id="codeActionDelBtn" type="button" class="btn btn-danger btn-sm"><spring:message code="btn.delete"/></button>
