...
<div class="topbar-left">
	<ol class="breadcrumb">
		<li class="crumb-active"><a href="###"><spring:message code="menu.990701" /></a></li>
		<li class="crumb-icon"><a href="/dashboard/main.do"><span class="glyphicon glyphicon-home"></span></a></li>
		<li class="crumb-trail"><spring:message code="menu.990000" /></li>
		<li class="crumb-trail"><spring:message code="menu.990700" /></li>
	</ol>
</div>
	...
	<div class="panel"> 
		...
		<div class="panel-footer clearfix">
			<div class="pull-right">
				<button id="infoAccountItsmeBtn" type="submit" class="btn btn-primary btn-sm"><spring:message code="btn.confirm"/></button>
			</div>
		</div>
