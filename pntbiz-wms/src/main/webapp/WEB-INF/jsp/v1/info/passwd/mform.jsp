...
<script type="text/javascript" src="${viewProperty.staticUrl}/js/info/infoPassword.js?v=<spring:eval expression='@config[buildVersion]'/>"></script>
</head>
<body>
	...
	<div class="panel"> 
		...
		<div class="panel-footer clearfix">
			<div class="pull-right">
				<button id="infoPasswordModBtn" type="button" class="btn btn-primary btn-sm"><spring:message code="btn.update"/></button>
			</div>
		</div>
