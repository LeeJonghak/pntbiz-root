...
<head>
	...
	<script>
		...
		$(document).ready(function() {
			...
			$('input[name=rdoBenefit2][value=' + $('input[name=benefit2UseYn]').val() + ']').attr('checked','checked');
			if ( $('input[name=benefit2UseYn]').val() == 'Y'){
				$('input[name=benefit2Msg]').removeAttr("readonly");
			}
			
			$('input[name=rdoOrderYN][value=' + $('input[name=orderUseYn]').val() + ']').attr('checked','checked');
			if ( $('input[name=orderUseYn]').val() == 'Y'){
				$('input[name=orderUseCnt]').removeAttr("readonly");
			}else{
				$('input[name=orderUseCnt]').val("0");
			}
...
<input type='hidden' name='benefit1UseYn' 	value='${item.benefit1UseYn }'/>
<input type='hidden' name='benefit2UseYn' 	value='${item.benefit2UseYn }'/>
