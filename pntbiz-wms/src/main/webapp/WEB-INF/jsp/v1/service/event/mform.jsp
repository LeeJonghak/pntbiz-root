...
<input type='hidden' name='benefit1SeatBlock'		/>
<input type='hidden' name='benefit1SeatCol'			/>
<input type='hidden' name='benefit1SeatNum'			/>
<input type='hidden' name='benefit2UseYn' />
<input type='hidden' name='benefit2SeatBlock'		/>
<input type='hidden' name='benefit2SeatCol'			/>
<input type='hidden' name='benefit2SeatNum'			/>
...
<div class="center">
	...
	<button id="eventListBtn" type="button" class="btn btn-default btn-sm" onClick="common.redirect('/service/event/list.do')">리스트</button>
</div>
