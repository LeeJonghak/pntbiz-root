...
<div class="col-sm-6">
	<h3><spring:message code="word.contents.list" /><small></small></h3>
</div>
<div class="col-sm-6">
...
<table class="table table-bordered table-hover table-responsive" onclick="sortColumn(event)">	
	...
	<tr class="active">
		...
		<th><spring:message code="word.advertising.provider" /></th>
		<th><spring:message code="word.register" /></th>
		<th><spring:message code="word.validity.date" /></th>
	</tr>
	</thead>
	<tbody>
	<c:forEach var="list" items="${list}" >		
	<tr align="center">
		<td><button type="button" class="btn btn-danger btnSelContents" data-connum="${list.conNum}" data-connm="${list.conName}" data-contypetext="${list.conTypeText}"><spring:message code="word.choose" /></button></td>
		<td>${list.conNum}</td>
