	...
	<script>
		$(function(){
			...
			$('#translationRegBtn').click(function(){
				...
				if ( $('input[name=visitCntUseYn]').val() == 'N' ){
...
<div class="form-group">
	<label class="col-sm-2 control-label"><spring:message code="word.prize.seat"/> 1</label>
	<div class="col-sm-10">
		<!--  
		<div class="col-sm-2 form-group">
		...
		<div class="col-sm-8 form-group">
			<div class="col-sm-2 form-group">
				<div class="input-group">
					...
					<span class="input-group-addon"><spring:message code="word.block" /></span>
				</div>
			</div>
			<div class="col-sm-2 form-group">
				<div class="input-group">
					<input type="text" name="benefit1SeatCol" class="form-control input-sm" size="5" maxlength="3" value="" >
					<span class="input-group-addon"><spring:message code="word.row" /></span>
				</div>
			</div>
			<div class="col-sm-2 form-group">
				<div class="input-group">
					<input type="text" name="benefit1SeatNum" class="form-control input-sm" size="5" maxlength="3" value="" >
					<span class="input-group-addon"><spring:message code="word.seat.number" /></span>
				</div>
			</div>
		</div>
	</div>
...
<div class="form-group">
	<label class="col-sm-2 control-label"><spring:message code="word.prize.seat"/> 2</label>
	<div class="col-sm-10"> 
		<!-- 
		<div class="col-sm-2 form-group">
