...
<input type='hidden' name='benefit1Msg'				value='${item.benefit1Msg }'/>
<input type='hidden' name='benefit1SeatBlock'		value='${item.benefit1SeatBlock }'/>
<input type='hidden' name='benefit1SeatCol'			value='${item.benefit1SeatCol }'/>
<input type='hidden' name='benefit1SeatNum'			value='${item.benefit1SeatNum }'/>
<input type='hidden' name='benefit2UseYn' 			value='N'/>
<input type='hidden' name='benefit2Msg'				value='${item.benefit2Msg }'/>
<input type='hidden' name='benefit2SeatBlock'		value='${item.benefit2SeatBlock }'/>
<input type='hidden' name='benefit2SeatCol'			value='${item.benefit2SeatCol }'/>
<input type='hidden' name='benefit2SeatNum'			value='${item.benefit2SeatNum }'/>
<input type='hidden' name='nakchomComm' 			value='${item.nakchomComm }'/>
...
<!-- 
<div class="form-group">
	<label class="col-sm-2 control-label">당첨혜택1</label>
	<div class="col-sm-10"> 
		<input type="text" name="benefit1Msg" class="form-control input-sm" size="5" maxlength="255" value="${item.benefit1Msg}">
	</div>
</div>

<div class="form-group">
	<label class="col-sm-2 control-label">당첨혜택2</label>
	<div class="col-sm-10"> 
		<div class="col-sm-2 form-group">
			<input type="radio" name="rdoBenefit2" value="Y" >사용
			<input type="radio" name="rdoBenefit2" value="N" checked="checked">사용안함
		</div>
		<div class="col-sm-2 form-group">
			<input type="text" name="benefit2Msg" class="form-control input-sm" size="5" maxlength="255" value="${item.benefit2Msg}" readonly="readonly">
		</div>
	</div>
</div>
...
<div class="form-group">
	...
	<div class="col-sm-10"> 
		...
		<div class="col-sm-2 form-group">
			<input type="text" name="nakchomComm" class="form-control input-sm" size="5" maxlength="255" value="" readonly="readonly">
		</div>
	</div>
</div>

<div class="form-group">
	<label class="col-sm-2 control-label">선착순 당첨인원</label>
	<div class="col-sm-10"> 
		<div class="col-sm-2 form-group">
			<input type="radio" name="rdoOrderYN" value="Y" >사용
			<input type="radio" name="rdoOrderYN" value="N" checked="checked">사용안함
		</div>
		<div class="col-sm-2 form-group">
			<div class="input-group">
				<input type="text" name="orderUseCnt" class="form-control input-sm" size="5" maxlength="3" value="${item.orderCnt}" readonly="readonly">
