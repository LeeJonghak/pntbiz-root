...
<div class="topbar-left">
	<ol class="breadcrumb">
		<li class="crumb-active"><a href="###"><spring:message code="menu.170302" /></a></li>
		...
		<div class="panel-body pn">
			<table class="table table-striped table-hover" onclick="sortColumn(event)">
				...
				<tr>
					...
					<th class="hidden-xs"><spring:message code="word.geofencing" /> <spring:message code="word.no" /></th>
				...
				<tr>
					...
					<td class="hidden-xs"><span class="label bg-danger">${list.fcNum}</span></td>
					<td>${list.fcName}</td>
					<td>${list.floor}</td>
					<td>
