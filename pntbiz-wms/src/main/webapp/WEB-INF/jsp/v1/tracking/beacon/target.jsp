...
<script type="text/javascript" src="${viewProperty.staticUrl}/js/tracking/presenceBeaconTarget.js?v=<spring:eval expression='@config[buildVersion]'/>"></script>
...
$(document).ready(function() {
	$.gmap.load({
		...
		height: "700px",
		div: "map-canvas",
		func: function(){presenceBeaconTarget.init();}
	});	
});
</script>
</head>
...
<div class="topbar-left">
	<ol class="breadcrumb">
		<li class="crumb-active"><a href="###"><spring:message code="menu.170211" /></a></li>
			...
			<div class="row">
				<div class="col-xs-12 col-md-12">
					...
					<div class="input-group">
						...
						<input type="text" id="phoneNumber" name="phoneNumber" class="form-control" placeholder="010XXXXYYYY" value="${param.phoneNumber}" />
					</div>
					<button id="presenceBeaconTargetRunBtn" type="button" class="btn btn-default btn-sm"><spring:message code="btn.run" /></button>
					<button id="presenceBeaconTargetDataBtn" type="button" class="btn btn-default btn-sm" data-toggle="collapse" data-target="#presenceBeaconLog" aria-expanded="false" aria-controls="presenceBeaconLog"><spring:message code="btn.log.view" /> <span id="logBadge" class="badge">0</span></button>
				<button id="presenceBeaconLogDownloadBtn" type="button" class="btn btn-default btn-sm"><spring:message code="btn.log.download" /></button>
				</div>
			</div>
		</div>
		
		<div class="panel-body pn">
			<div class="collapse" id="presenceBeaconLog">
				<table class="table table-striped table-hover" id="presenceBeaconLogTable" data-toggle="table" data-height="300">
					<thead>
					<tr class="active" width="97%">
						<th data-field="logNum">No.</th>
						<th data-field="phoneNumber">phoneNumber</th>
						<th data-field="deviceInfo">deviceInfo</th>
