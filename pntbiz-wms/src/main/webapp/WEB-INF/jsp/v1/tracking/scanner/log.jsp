...
<div class="topbar-left">
	<ol class="breadcrumb">
		<li class="crumb-active"><a href="###"><spring:message code="menu.170301" /></a></li>
		...
		<div class="panel-body pn">
			<table class="table table-striped table-hover" onclick="sortColumn(event)">
				...
				<tr>
					...
					<td>${list.floor}</td>
					<td class="hidden-xs">${list.logDesc}</td>
					<td>${list.lat}/${list.lng}</td>
					<td><jsp:useBean id="regDate" class="java.util.Date"/>
