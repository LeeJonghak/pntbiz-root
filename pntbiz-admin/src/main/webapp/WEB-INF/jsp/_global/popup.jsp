...
<script type="text/javascript" src="<spring:eval expression='@config[staticURL]'/>/external/js.jquery.mask/jquery.mask.min.js?v=<spring:eval expression='@config[buildVersion]'/>"></script>
