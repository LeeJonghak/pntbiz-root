...
<input type="hidden" id="authNum" name="authNum" value="${auth.authNum}" />
<div class="col-sm-6">
...
<div class="form-group">
	<label class="col-sm-2 control-label">권한번호</label>
	<div class="col-sm-10">
		<c:out value="${auth.authNum}" />
	</div>
</div>
<div class="form-group">
	<label class="col-sm-2 control-label">권한명</label>
	<div class="col-sm-10">
		<input type="text" id="authName" name="authName" value="<c:out value="${auth.authName}"/>" maxlength="50" class="form-control" placeholder="권한명"  />
	</div>
</div>
<div class="form-group">
	<label class="col-sm-2 control-label">권한코드</label>
	<div class="col-sm-10">
		<input type="text" id="authCode" name="authCode" value="<c:out value="${auth.authCode}"/>" maxlength="50" class="form-control" placeholder="권한코드"  />
	</div>
</div>
<hr />
<div class="center">
	<button id="loginAuthcodeModBtn" type="button" class="btn btn-primary btn-sm">수정</button>
	<button id="loginAuthcodeDelBtn" type="button" class="btn btn-default btn-sm" >삭제</button>
