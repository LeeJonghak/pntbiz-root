	...
	public int doEndTag() throws JspException {
		try {
			...
			if (page == null) {
				...
				RequestDispatcher rd = pageContext.getServletContext().getRequestDispatcher(fullPath.replace("${viewVersion}", viewVersion));
			...
			if (d != null && d.getPage() != null) {
				...
				Map<String, Object> viewProperty = (Map<String, Object>)pageContext.getRequest().getAttribute("viewProperty");
				String viewVersion = "";
				if(viewProperty!=null && viewProperty.containsKey("viewVersion")) {
					viewVersion = (String)viewProperty.get("viewVersion");
				}
				pageContext.include(d.getPage().replace("${viewVersion}", viewVersion));
			}
			else {
