package admin.oauth.controller;

import core.admin.oauth.domain.OauthClient;
import admin.oauth.service.OauthAccessTokenService;
import admin.oauth.service.OauthClientService;
...
public class OauthClientController {
    ...
    @RequestMapping("/admin/oauth/client/list.do")
    public String list(ModelMap map, PagingParam paging) {
        ...
        return "/admin/oauth/client/list";
    }

    @RequestMapping(value= "/admin/oauth/client/form.do", method= RequestMethod.GET)
    public String form() {

        return "/admin/oauth/client/form";
    }

    @RequestMapping(value= "/admin/oauth/client/reg.do", method= RequestMethod.POST)
    @ResponseBody
    ...
    @RequestMapping(value= "/admin/oauth/client/mform.do", method= RequestMethod.GET)
    public String form(ModelMap map, @RequestParam(value = "id", required = true)String clientID) {
        ...
        return "/admin/oauth/client/mform";
    }

    @RequestMapping(value= "/admin/oauth/client/mod.do", method= RequestMethod.POST)
    @ResponseBody
    ...
    @RequestMapping(value= "/admin/oauth/client/del.do", method= RequestMethod.POST)
    @ResponseBody
